      ...
      >
        ...
        >
          ...
          <p className="fs-5 lh-lg text-secondary">
            ...
            create{" "}
            <span className="text-warning fw-bold">lasting landmarks</span>. We
            are a trusted name in{" "}
            <b>civil, structural, and MEP engineering</b>, committed to
            transforming visions into sustainable, functional, and innovative
            spaces.
          </p>
          <p className="fs-5 lh-lg text-secondary">
            With expertise in{" "}
            <b>residential, commercial, and industrial</b> projects, we
            integrate <b>modern design, technology, and eco-friendly practices</b>{" "}
            to deliver excellence in every square foot we build.
          </p>
          <p className="fs-5 lh-lg text-secondary">
            Our mission is driven by quality, integrity, and innovation —
            ensuring each project reflects our dedication to{" "}
            <b>engineering precision and architectural excellence</b>.
          </p>
        </motion.div>
      </motion.section>
      ...
      <section className="container my-5">
        ...
        <div className="row align-items-center g-5">
          ...
          >
            ...
            <p className="fs-5 lh-lg text-secondary">
              To emerge as a{" "}
              <b>leading force in smart, sustainable infrastructure</b> and
              engineering excellence — delivering projects that embody
              innovation, safety, and long-term value.
            </p>
            <p className="fs-5 lh-lg text-secondary">
              We envision a future where{" "}
              <b>green construction, MEP integration, and modern architecture</b>{" "}
              come together to build not just structures but{" "}
        ...
        <div className="row align-items-center g-5 mt-5 flex-md-row-reverse">
          ...
          >
            ...
            <p className="fs-5 lh-lg text-secondary">
              To lead with <b>innovation, precision, and integrity</b> —
              providing end-to-end{" "}
              <b>construction and MEP solutions</b> that align with modern
              sustainability goals.
            </p>
            <p className="fs-5 lh-lg text-secondary">
              Our mission is to transform every blueprint into reality by
              combining <b>engineering excellence</b>, <b>quality materials</b>,
              and <b>client-focused delivery</b>.
            </p>
          </motion.div>
        </div>
      </section>
